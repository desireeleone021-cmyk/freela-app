      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-900">Freela</span>
          </div>
          <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-xs font-bold text-indigo-600">{initials}</div>
        </header>
